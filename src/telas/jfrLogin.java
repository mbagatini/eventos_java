...
import apoio.Progress;
import entidade.Usuario;
import static java.awt.Color.white;
import java.util.logging.Level;
import java.util.logging.Logger;
import javax.swing.JProgressBar;
import rest.UsuarioREST;
...
public class jfrLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario usu = null;
        try {
            usu = rest.validarLogin(jtfLogin.getText(), Criptografia.criptografar(jpfSenha.getText()));
        } catch (Exception ex) {
            Logger.getLogger(jfrLogin.class.getName()).log(Level.SEVERE, null, ex);
        }

        //Usuario usu = dao.autenticarColaborador();
        if (usu != null) {
